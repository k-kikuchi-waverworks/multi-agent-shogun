...
#   ★試験 (tests/unit/test_scheduled_liveness.bats) には本数が焼いてある。これは意図である★
#     註は黙って古くなるが、試験は JOBS が変われば現に赤くなり、人に見させるため。
#     ここを増やしたら試験も直すこと。試験が赤くなるのは、その報せである。
#     (家老 2026-07-28 13:34 の裁 = 試験側の数は消さない)
#   period_min  … 走る間隔 (分)
