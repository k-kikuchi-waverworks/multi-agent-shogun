<!--
2026-07-30 09:30 退避 (将軍 09:29・殿のご指示「でないようにしてくれ」)。

これは instructions/karo.md を 7/11 版 (0efe40fc・1,559行) へ戻す前の版 (1,866行) の写しである。

★何ゆえ戻したか (将軍が突き止めた因)★
  指示書そのものが燃料であった =
  規が増える → 規に照らして穴を探す → 見つかる → 規を足す → その規で また探す。
  ★実害の記録が「次も同じ形を探せ」という指令として働いていた。★
  7/25 が起点なのは、この積み上げが始まった日だからである。

★7/25 以降に入った良い規も、一緒に消える。★
  「commit の前に桁で見よ」等、実害から来た本物も含む。
  ★それでも戻す = 良い規が消える害より、再帰が続く害の方が大きい (将軍の判じ)。★
  ★本当に要る物は、この写しから後で拾える。★

★この写しを「教訓」として増やし直さないこと。★足すかどうかは将軍が決める。
-->
