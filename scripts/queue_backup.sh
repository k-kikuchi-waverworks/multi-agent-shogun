...
write_end_stamp() {
  ...
  # 書けたことも黙らせない。之が無いと、log だけを見る者には
  # 「書けたのか・書く所まで来なかったのか」が区別できない (家老の裁・2026-08-03 10:03)。
  # 旧版 (scheduled_liveness_check.py) が出していた 1 行を、同じ形で戻す。
  printf '[liveness] 終わりの証を書いた: %s\n' "$file"
  return 0
}
